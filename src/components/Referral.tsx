            ...
            <Stagger className="relative mt-14 grid gap-5 md:grid-cols-3">
              {STEPS.map((s, i) => (
                <motion.div key={s.step} variants={staggerChild} className="relative">
                  ...
                  <div className="group h-full rounded-[1.75rem] border border-ink/[0.07] bg-white/80 p-7 shadow-soft transition-all duration-400 hover:-translate-y-1.5 hover:shadow-lift">
